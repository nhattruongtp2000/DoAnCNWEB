...
namespace WebAPI.BackendAPI.Controllers
{
    ...
    public class SizesController : ControllerBase
    {
        ...
        {
            var products = await _sizeService.GetAll(languageId);
            return Ok(products);
        }
        ...
        public async Task<IActionResult> GetById(string idSize, string languageId)
        {
            var size = await _sizeService.GetById(idSize, languageId);
            if (size == null)
        ...
        public async Task<IActionResult> Create([FromForm] SizeCreateRequest request)
        {
            ...
            var product = await _sizeService.GetById(idSize, request.LanguageId);
